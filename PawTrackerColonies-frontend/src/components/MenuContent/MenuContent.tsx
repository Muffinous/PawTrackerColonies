            ...
            <IonContent>
                ...
                <IonList>
                    ...
                    <IonItem onClick={handleNewColony}>
                        <IonLabel>Register a Colony</IonLabel>
                    </IonItem>
                    <IonItem onClick={handleNewCat}>
                        <IonLabel>Register a Cat</IonLabel>
                    </IonItem>
                    <IonItem onClick={handleCalendar}>
                        <IonLabel>Feeding calendar</IonLabel>
                    </IonItem>
                </IonList>
            </IonContent>
        </IonMenu>
